## v0.6.3.1 A2A campaign — Phase 5 verdict roll-up (2026-05-04T00:29:33Z)

- **Campaign:** `a2a-hermes-v0.6.3.1-r15`
...
- **[medium]** `cap-C-treatment-r3` (needs_review) — treatment run C/r3 hit cap_reached_walltime
