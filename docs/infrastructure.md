...
| Agent droplet size — hermes  | **`s-4vcpu-8gb` (hard-coded; see [#40](https://github.com/alphaonedev/ai-memory-a2a-v0.6.3.1/issues/40))** | Basic tier, 4 vCPU, 8 GB RAM, ~$0.06/hr — Python LLM stack needs 8GB headroom; agent_droplet_size workflow input is **ignored** for `agent_group=hermes` |
